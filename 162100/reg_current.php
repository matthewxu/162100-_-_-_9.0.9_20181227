...
<div class="i3">&nbsp;</div>
<div id="nav">
  <div id="nav_mingz"><a href="member_current.php" target="_self">用户中心</a> / 注册</div>
  <div id="nav_session"><a href="reg.php" title="展开" target="_parent"><img src="readonly/images/y.gif" class="close" /></a> <a href="about:blank" title="关闭" onclick="parClose()" target="_self"><img src="readonly/images/x.gif" class="close" /></a></div>
</div>
  ...
  <table width="100%" border="0" cellspacing="10" cellpadding="0" class="menu">
    <tr>
      <td class="menu_left"><p>欢迎注册！</p>
          ...
          <p>&nbsp;</p>
          <p>已有帐号？</p>
          <p><button name="submit" type="submit" class="send1" style="border:none;" onclick="location.href='login_current.php';">立即登陆</button></p></td>
