...
<style type="text/css">
<!--
#optionMenu li { float:left; /*display:inline-block !important; display:inline; zoom:1;*/ }
-->
</style></head>
...
<div class="i3">&nbsp;</div>
<div id="nav">
  <div id="nav_mingz"><a href="member_current.php" target="_self">用户中心</a> / 登陆</div>
  <div id="nav_session"><a href="login.php" title="展开" target="_parent"><img src="readonly/images/y.gif" class="close" /></a> <a href="about:blank" title="关闭" onclick="parClose()" target="_self"><img src="readonly/images/x.gif" class="close" /></a></div>
</div>
<div id="body" style="overflow:visible"><div id="body_p">
  <table width="100%" border="0" cellspacing="10" cellpadding="0" class="menu">
    <tr>
      <td class="menu_left"><p>欢迎登陆！</p>
          ...
          <p>&nbsp;</p>
          <p>没有帐号？</p>
          <p><button name="submit" type="submit" class="send1" style="border:none;" onclick="location.href='reg_current.php';">立即注册</button></p></td>
      <td class="menu_right"><form class="left_" style="height:auto;overflow:visible;" action="member.php?post=login" method="post" onsubmit="return postChk();" enctype="multipart/form-data" id="loginform">
